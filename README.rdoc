...
Declaratively bind an object's instance variables and methods to OSC events.  Declaration can be done during class definition, by calling instance methods, or by passing in a Hash map.
...
OR by using a Hash map such as:
  ...
  @i3 = Instrument.new
  @i3.osc_output(:host => "192.168.1.5", :port => 9000)
