...
* Management and sharing of OSC clients is invisible to the user, allowing easy multiplexing and other scenarios.
* Bind events at class definition; using instance methods; by passing in a Hash map
* Shortcuts for common tasks associated with OSC such as translating values from one range to another
