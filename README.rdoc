...
Declaratively bind an object's instance variables and methods to OSC events.  Declaration can be done in the class definition, by calling instance methods, or by passing in a Hash map.
