...
Input is initiated by specifying an input port as in the example.  OSC server/client sharing and management is encapsulated under the hood and invisible to the user.
