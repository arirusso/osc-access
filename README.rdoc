...
There are two ways to use osc-object: by class definition or instance methods

==== Class Definition

By defining attr_osc, the pitch attribute of Instrument objects will then be controlled by OSC messages with the address "/1/fader1"
