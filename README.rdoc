...
Requires {eventmachine}[http://github.com/eventmachine/eventmachine] and {osc-ruby}[http://github.com/aberant/osc-ruby] 

On Linux and OSX, {dnssd}[http://github.com/tenderlove/dnssd] is required too.  Zeroconf is not currently supported under windows
