...
* Binding OSC events can be done in a class definition or from instance to instance
...
Or, here is the same object but created by passing a Hash map to the instance:
