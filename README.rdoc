...
In this example when OSC messages for <em>/1/fader1</em> are received, <em>velocity=</em> is called 
...
{Here's a blog post}[] that explains these examples in a bit further depth.
